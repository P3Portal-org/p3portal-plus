    ...
    <div className="border border-gray-200 dark:border-zinc-700 rounded-lg bg-gray-50/50 dark:bg-zinc-800/30 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 dark:bg-zinc-800/70 border-b border-gray-200 dark:border-zinc-700">
        ...
        <button
          ...
          className="text-xs text-portal-danger hover:text-portal-danger transition-colors flex items-center gap-1"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="md:col-span-2">
            <label className={labelCls}>
              Regelname <span className="text-portal-danger">*</span>
            </label>
            <input
              className={inputCls}
              value={rule.name}
          ...
          <div>
            <label className={labelCls}>
              Metrik <span className="text-portal-danger">*</span>
            </label>
            <select
              className={inputCls}
              value={rule.metric}
            ...
            <div>
              ...
              <label className="flex items-center gap-2 px-3 py-2 border border-gray-200 dark:border-zinc-700 rounded bg-white dark:bg-zinc-800 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-portal-accent focus:ring-portal-accent"
                />
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              {rules.length > 0 && (
                <button
                  type="button"
                  onClick={addRule}
                  className="text-xs text-portal-accent hover:underline transition-colors shrink-0"
                >
                  + Regel hinzufügen
                </button>
              )}
            ...
            {rules.length === 0 ? (
              <button
                type="button"
                onClick={addRule}
                className="w-full border-2 border-dashed border-gray-300 dark:border-zinc-700 rounded-lg py-8 text-sm text-gray-500 dark:text-zinc-400 hover:border-portal-accent/50 hover:text-portal-accent transition-colors flex flex-col items-center gap-2"
              >
        ...
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-t border-gray-100 dark:border-zinc-800 shrink-0 bg-gray-50/50 dark:bg-zinc-900/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm rounded-lg bg-portal-accent hover:bg-portal-accent text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
